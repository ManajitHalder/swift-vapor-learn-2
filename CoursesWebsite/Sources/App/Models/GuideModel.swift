...
final class GuideModel: Model {
    static var schema: String = SchemaEnum.guides.rawValue
    ...
    init(title: String?, description: String?, headerImage: URL?, price: PriceEnum.RawValue?, status: StatusEnum.RawValue?, slug: String?, tags: [String]?, publishDate: Date?, createdAt: Date?, updatedAt: Date?, author: String?) {
        self.title = title
