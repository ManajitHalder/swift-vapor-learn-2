...
final class SessionModel: Model {
    ...
    init(title: String?, mp4URL: URL?, hlsURL: URL?, createdAt: Date?, updatedAt: Date?, published: Date?, status: StatusEnum.RawValue?, price: PriceEnum.RawValue?, article: String?, course: CourseModel.IDValue?, slug: String?) {
        self.title = title
        self.mp4URL = mp4URL
        self.hlsURL = hlsURL
